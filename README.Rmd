...
The package is currently under re-development and some functions do not work well, e.g. the Shiny app.
The functions related to weather data, e.g. `sebms_weather_png()`, `sebms_sunhours_data()`, `sebms_sunhour_plot ()`, and `sebms_sundiff_plot()`, as well as the functions that create species abundance plots work well and produce pngs ready to use in reports.
...
For the sun hour figure for the same year do `sebms_sunhour_plot(2022)`.
