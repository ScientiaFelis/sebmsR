...
To compare a regional index for a species with the national Sweden index use `get_trimComparedPlots()` and set *Län*, *Landskap*, or *Kommun* to the desired region.
